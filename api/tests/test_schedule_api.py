...
class ScheduleApiTest(APITestCase):
    ...
    def test_get_lessons_list_for_professor(self):
        ...
        self.assertEqual(lessonsCountPerWeek, 14)

    def test_get_lessons_list_per_denominator_for_professor(self):
        token = self.response.data['access']
        self.client.credentials(HTTP_AUTHORIZATION=f'Bearer {token}')
        ...
        self.assertEqual(lessonsCountPerDenominator, 9)
    ...
    def test_get_lessons_list_for_student(self):
        ...
        self.assertEqual(lessonsCountPerTwoWeek, 13)
